...
from mailing_service.services import block_mailing, run_mail
from mailing_service.views import (Contacts, MailingAttemptCreateView, MailingAttemptListView, MailingCreateView,
...
urlpatterns = [
    ...
    # path('send_mailing/', run_mail, name="run_mail"),
]
